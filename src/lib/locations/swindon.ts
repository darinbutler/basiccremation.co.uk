...
export const swindonLocation: LocationData = {
  ...
  faqs: [
    {
      question: "Which Swindon crematorium will be used?",
      answer:
    ...
    {
      question: "How quickly can you collect from a Swindon hospital?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes — we work with funeral directors and crematoria right across Wiltshire. The £1,499 price is the same wherever you are."
    },
    {
