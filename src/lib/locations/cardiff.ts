...
export const cardiffLocation: LocationData = {
  slug: "cardiff",
  city: "Cardiff",
  region: "Cardiff & South Wales",
  country: "Wales",
  metaTitle: "Basic Cremation Cardiff | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Cardiff for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and South Wales crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Cardiff",
  lede:
  ...
  crematoria: [
    ...
    {
      name: "Croesyceiliog Crematorium",
  ...
  registerOffice: {
    ...
    address: "Cardiff Council Building, Cathays Park, Cardiff CF10 3ND",
    phone: "029 2087 1690",
    email: "register@cardiff.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      name: "University Hospital of Wales (UHW)",
      note: "Bereavement Office, Heath Park, Cardiff CF14 4XW. The largest hospital in Wales — call ahead before visiting."
    },
    {
      name: "University Hospital Llandough",
      note: "Bereavement Office, Penlan Road, Llandough CF64 2XX. Open weekdays."
    },
    {
      name: "Cardiff and Vale UHB community sites",
      note: "Smaller community hospital sites coordinate via the central Cardiff & Vale UHB bereavement office."
    }
  ],
  ...
  supportServices: [
    {
      ...
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Wales — Cymraeg and English.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "Marie Curie Hospice Cardiff and the Vale — Bereavement Service",
      phone: "029 2042 6000",
      description: "Bereavement counselling open to anyone in Cardiff and the Vale, regardless of whether you used hospice services.",
      url: "https://www.mariecurie.org.uk"
    },
    {
      name: "Tŷ Hafan Children's Hospice — bereavement",
      phone: "029 2053 2199",
      description: "Bereavement support for families across South Wales following the death of a child.",
      url: "https://www.tyhafan.org"
    },
    {
      name: "City Hospice — Bereavement Service",
      phone: "029 2052 4150",
      description: "Cardiff-based hospice offering bereavement counselling.",
      url: "https://www.cityhospice.org.uk"
    }
  ],
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Cardiff cremation?",
      answer:
    ...
    {
      question: "Do you provide service in Welsh / Cymraeg?",
      answer:
    ...
    {
      question: "Do you cover Newport, Swansea and the Valleys?",
      answer:
    ...
    {
      question: "How quickly can you collect from UHW or Llandough?",
      answer:
    ...
    {
      question: "Can ashes be scattered on a Welsh beach or in the Brecon Beacons?",
      answer:
