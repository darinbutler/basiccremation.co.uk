...
export const brightonLocation: LocationData = {
  slug: "brighton",
  city: "Brighton",
  region: "East Sussex & the South Coast",
  country: "England",
  metaTitle: "Basic Cremation Brighton | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Brighton for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and East Sussex & the South Coast crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Brighton",
  lede:
  ...
  crematoria: [
    {
      name: "Woodvale Cemetery and Crematorium",
      address: "Lewes Road, Brighton BN2 3QB",
      note:
    ...
    {
      name: "Downs Crematorium",
      address: "Bear Road, Brighton BN2 3PL",
      note:
  ...
  registerOffice: {
    name: "Brighton & Hove Register Office",
    address: "Brighton Town Hall, Bartholomew Square, Brighton BN1 1JA",
    phone: "01273 292016",
    email: "registrars@brighton-hove.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Eastern Road, BN2 5BE. Call ahead before visiting."
    },
    {
      name: "Princess Royal Hospital (Haywards Heath)",
      note: "Bereavement Services, Lewes Road, RH16 4EX."
    }
  ],

  supportServices: [
    {
      name: "Martlets Hospice — Bereavement",
      phone: "01273 273400",
      description: "Brighton-based hospice offering bereavement counselling.",
      url: "https://www.martlets.org.uk"
    },
    {
      name: "Cruse Bereavement Support — Sussex",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Sussex.",
  ...
  cityImage:
    "https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=1800&q=75",
  cityImageAlt: "Brighton — South Coast beachfront"
};
