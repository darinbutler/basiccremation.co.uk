...
export const hullLocation: LocationData = {
  slug: "hull",
  city: "Hull",
  region: "East Yorkshire",
  country: "England",
  metaTitle: "Basic Cremation Hull | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Hull for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and East Yorkshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Hull",
  lede:
  ...
  crematoria: [
    {
      name: "Chanterlands Avenue Crematorium",
      address: "Chanterlands Avenue, Hull HU5 4EF",
      note:
        "Hull City Council’s principal crematorium, opened in 1908. One of the oldest crematoria in Yorkshire."
    },
    {
      name: "Eastern Cemetery and Crematorium",
      address: "Preston Road, Hull HU9 5HF",
      note:
        "Hull City Council’s second crematorium, serving the east of the city."
    },
    {
      name: "Haltemprice Crematorium",
      address: "Hull Road, Willerby HU10 7BG",
      note:
  ...
  registerOffice: {
    name: "Hull Register Office",
    address: "181 George Street, Hull HU1 3BY",
    phone: "01482 300 300",
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Anlaby Road, HU3 2JZ. Call ahead before visiting."
    },
    {
      name: "Castle Hill Hospital",
      note: "Bereavement Services, Castle Road, Cottingham HU16 5JQ."
    }
  ],

  supportServices: [
    {
      name: "Dove House Hospice — Bereavement Service",
      phone: "01482 785 780",
      description: "Hull-based hospice offering bereavement counselling.",
      url: "https://www.dovehouse.org.uk"
    },
    {
      name: "Cruse Bereavement Support — East Yorkshire",
      phone: "0808 808 1677",
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Hull cremation?",
      answer:
    ...
    {
      question: "How quickly can you collect from Hull Royal Infirmary or Castle Hill?",
      answer:
    ...
    {
      question: "Do you cover Beverley, Cottingham, Hessle, Driffield and the East Riding?",
      answer:
    ...
    {
      question: "Can ashes be scattered on the Yorkshire Wolds or by the Humber?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Hull?",
      answer:
    ...
    {
      question: "Can I have a memorial gathering separately from the cremation?",
      answer:
  ...
  cityImageAlt: "Hull — peaceful local scene"
};
