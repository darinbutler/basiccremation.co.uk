...
export const southamptonLocation: LocationData = {
  slug: "southampton",
  city: "Southampton",
  region: "Hampshire",
  country: "England",
  metaTitle: "Basic Cremation Southampton | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Southampton for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Hampshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Southampton",
  lede:
  ...
  crematoria: [
    {
      name: "Hollybrook Cemetery and Crematorium",
      address: "Tremona Road, Southampton SO16 6HH",
      note:
  ...
  registerOffice: {
    name: "Southampton Register Office",
    address: "6A Bugle Street, Southampton SO14 2LX",
    phone: "023 8083 3008",
    email: "register.office@southampton.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Tremona Road, SO16 6YD. Call ahead before visiting."
    },
    {
      name: "Princess Anne Hospital (women's)",
      note: "Co-located with Southampton General. Specialist pregnancy and neonatal bereavement."
    }
  ],

  supportServices: [
    {
      name: "Mountbatten Hospice (Solent) — Bereavement Service",
      phone: "023 8061 1414",
      description: "Southampton hospice offering bereavement counselling.",
      url: "https://www.mountbatten.org.uk"
    },
    {
  ...
  cityImage:
    "/images/cities/southampton.jpg",
  cityImageAlt: "Southampton — South Coast atmosphere"
};
