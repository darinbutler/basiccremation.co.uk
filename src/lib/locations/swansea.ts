...
export const swanseaLocation: LocationData = {
  slug: "swansea",
  city: "Swansea",
  region: "Swansea & South West Wales",
  country: "Wales",
  metaTitle: "Basic Cremation Swansea | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Swansea for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Swansea & South West Wales crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Swansea",
  lede:
  ...
  crematoria: [
    {
      name: "Swansea Crematorium",
      address: "Pant-Y-Eos, Morriston, Swansea SA6 6QG",
      note:
        "Swansea Council’s crematorium, set in extensive grounds at Morriston in the north of the city."
    },
    {
      name: "Parc Gwyn Crematorium",
      address: "Narberth, Pembrokeshire SA67 8UD",
      note:
  ...
  registerOffice: {
    name: "Swansea Register Office",
    address: "County Hall, Oystermouth Road, Swansea SA1 3SN",
    phone: "01792 637444",
    email: "registration@swansea.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Heol Maes Eglwys, SA6 6NL. Call ahead before visiting."
    },
    {
      name: "Singleton Hospital",
      note: "Bereavement Services, Sketty Lane, SA2 8QA."
    }
  ],

  supportServices: [
    {
      name: "Tŷ Olwen — Bereavement Service",
      phone: "01792 703428",
      description: "Swansea palliative care unit offering bereavement counselling.",
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Swansea cremation?",
      answer:
    ...
    {
      question: "How quickly can you collect from Morriston or Singleton Hospital?",
      answer:
    ...
    {
      question: "Do you cover Sketty, Mumbles, Gowerton, Neath, Port Talbot and Llanelli?",
      answer:
    ...
    {
      question: "Can ashes be scattered on the Gower coast or in the Brecon Beacons?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Swansea?",
      answer:
  ...
  cityImageAlt: "Swansea — peaceful local scene"
};
