...
export const londonLocation: LocationData = {
  ...
  country: "England",
  metaTitle: "Basic Cremation London | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in London for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Greater London crematoria, all 32 boroughs and the City. 24/7 phone support.",
  h1: "Basic Cremation in London",
  lede:
  ...
  crematoria: [
    ...
    },
    {
      ...
      address: "Townmead Road, Richmond TW9 4EN",
      note:
    ...
    {
      name: "Putney Vale Crematorium",
      address: "Stag Lane, London SW15 3DZ",
      note:
    ...
    {
      name: "Streatham Park Cemetery and Crematorium",
      address: "Rowan Road, London SW16 5JG",
      note:
    ...
    {
      name: "Hendon Crematorium",
      address: "Holders Hill Road, London NW7 1NB",
      note:
    ...
    {
      name: "South Essex Crematorium",
      address: "Ockendon Road, Upminster RM14 2UY",
      note:
        "Operated by Havering Council, the principal crematorium serving Barking & Dagenham, Havering and the eastern London fringe."
    },
    {
      name: "Croydon Crematorium (Mitcham Road)",
      address: "Mitcham Road, Croydon CR9 3AT",
      note:
  ...
  registerOffice: {
    name: "London — borough register offices",
    address: "Each of the 32 London boroughs and the City of London operates its own register office",
    phone: "Variable by borough",
    email: "Variable by borough",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, ground floor, 235 Euston Road NW1 2BU. Call ahead before visiting; staff coordinate with the Medical Examiner."
    },
    {
      name: "King's College Hospital",
      note: "Bereavement Office at the Denmark Hill site, SE5 9RS. Phone first to arrange a time."
    },
    {
      name: "Guy's and St Thomas'",
      note: "Bereavement Care, ground floor, Lambeth Wing, St Thomas' Hospital SE1 7EH. Open weekdays."
    },
    {
      name: "Imperial College Healthcare (St Mary's, Charing Cross, Hammersmith)",
      note: "Bereavement Services with offices at each main site. Call the central bereavement line for guidance."
    },
    {
      name: "Royal London Hospital",
      note: "Bereavement Office, Whitechapel E1 1FR. The Royal London houses a public mortuary serving the East London coroner."
    }
  ],

  supportServices: [
    {
      name: "Cruse Bereavement Support — London",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across London. National helpline plus local volunteer-led services in most boroughs.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "At A Loss",
      description: "UK-wide signposting service connecting bereaved people to the right support locally. Useful when you're not sure what kind of help you need.",
      url: "https://www.ataloss.org"
    },
    {
      name: "London Friend (LGBTQ+ bereavement)",
      phone: "020 7833 1674",
      description: "Counselling and support for LGBTQ+ Londoners experiencing bereavement.",
      url: "https://londonfriend.org.uk"
    },
    {
      name: "Sands (stillbirth and neonatal death)",
      phone: "0808 164 3332",
      description: "National charity supporting families bereaved by stillbirth or neonatal death.",
      url: "https://www.sands.org.uk"
    },
    {
      name: "The Compassionate Friends",
      phone: "0345 123 2304",
      description: "Peer support for parents bereaved by the death of a child of any age.",
      url: "https://www.tcf.org.uk"
    },
    {
      name: "St Christopher's Hospice — Bereavement Service (south London)",
      phone: "020 8768 4500",
      description: "Bereavement counselling and support open to anyone in south London, regardless of whether you used hospice services.",
      url: "https://www.stchristophers.org.uk"
    }
  ],
  ...
  faqs: [
    {
      question: "Which London crematorium will be used?",
      answer:
    ...
    {
      question: "How quickly can you collect from a London hospital?",
      answer:
    ...
    {
      question: "Where do I register a death that occurred in central London?",
      answer:
    ...
    {
      question: "What if my loved one died at home in London?",
      answer:
    ...
    {
      question: "Can the ashes be scattered or buried in London?",
      answer:
    ...
    {
      question: "Why is the coroner involved? Is something wrong?",
      answer:
    ...
    {
      question: "Do you cover Outer London — Bromley, Croydon, Bexley, Hillingdon?",
      answer:
