...
export const liverpoolLocation: LocationData = {
  slug: "liverpool",
  city: "Liverpool",
  region: "Merseyside",
  country: "England",
  metaTitle: "Basic Cremation Liverpool | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Liverpool for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Merseyside crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Liverpool",
  lede:
  ...
  crematoria: [
    {
      name: "Anfield Crematorium",
      address: "Priory Road, Anfield, Liverpool L4 2SL",
      note:
    ...
    {
      name: "Springwood Crematorium",
      address: "Springwood Avenue, Allerton, Liverpool L25 7UN",
      note:
    ...
    {
      name: "Allerton Cemetery and Crematorium",
      address: "Springwood Avenue, Allerton, Liverpool L19 4LY",
      note:
        "Adjacent to Springwood, Allerton is the wider cemetery site. Together with Springwood it serves the south of the city."
    },
    {
      name: "West Derby Crematorium",
      address: "Mill Lane, West Derby, Liverpool L12 7LN",
      note:
    ...
    {
      name: "Landican Cemetery and Crematorium",
      address: "Arrowe Park Road, Birkenhead, Wirral CH49 5LW",
      note:
        "Wirral’s principal crematorium, serving Birkenhead, Wallasey, Bebington, Heswall and the Wirral peninsula."
    },
    {
      name: "Thornton Garden of Rest",
      address: "Lydiate Lane, Thornton, Liverpool L23 4UE",
      note:
  ...
  registerOffice: {
    name: "Liverpool Register Office",
    address: "St George's Hall, St George's Place, Liverpool L1 1JJ",
    phone: "0151 233 3004",
    email: "register.office@liverpool.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office at the Royal Liverpool, Mount Vernon Street, L7 8XP. Call ahead before visiting."
    },
    {
      name: "Aintree University Hospital",
      note: "Bereavement Services, Lower Lane, Fazakerley, L9 7AL. Open weekdays."
    },
    {
      name: "Liverpool Women's Hospital",
      note: "Bereavement support specialised in pregnancy loss, neonatal and women's health bereavement. Crown Street, L8 7SS."
    },
    {
      name: "Alder Hey Children's Hospital",
      note: "Specialist child bereavement support. Eaton Road, West Derby, L12 2AP."
    }
  ],

  supportServices: [
    {
      name: "Cruse Bereavement Support — Merseyside",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Liverpool and Merseyside.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "Marie Curie Hospice Liverpool — Bereavement Service",
      phone: "0151 801 1400",
      description: "Bereavement support open to anyone in Liverpool, regardless of whether you used hospice services.",
      url: "https://www.mariecurie.org.uk"
    },
    {
      name: "Claire House Children's Hospice — bereavement",
      phone: "0151 343 0883",
      description: "Bereavement support for families across Merseyside following the death of a child.",
      url: "https://www.claire-house.org.uk"
    },
    {
  ...
  faqs: [
    {
      question: "Which Liverpool crematorium will be used?",
      answer:
    ...
    {
      question: "Do you cover Wirral, Sefton, Knowsley and St Helens?",
      answer:
    ...
    {
      question: "How quickly can you collect from a Liverpool hospital?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Liverpool?",
      answer:
    ...
    {
      question: "Can ashes be scattered at sea or on the Mersey?",
      answer:
  ...
  cityImageAlt: "Liverpool — Liver Building waterfront"
};
