...
export const sloughLocation: LocationData = {
  slug: "slough",
  city: "Slough",
  region: "Berkshire",
  country: "England",
  metaTitle: "Basic Cremation Slough | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Slough for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Berkshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Slough",
  lede:
    "A simple, dignified cremation arranged across Slough and Berkshire — handled by trusted local funeral directors and local crematoria, never centralised hundreds of miles away.",

  localIntro: [
    "If you've lost someone in Slough or anywhere across Berkshire, we can help you arrange a basic cremation — also called a direct or unattended cremation. The whole process happens locally: an independent funeral director near you brings your loved one into care at their own funeral home, and the cremation takes place at one of the established Berkshire crematoria.",
    "Slough is in Berkshire. Slough Crematorium serves the borough and the southern Buckinghamshire fringe.",
  ...
  crematoriaIntro:
    "We work with Slough, Easthampstead Park — alongside other crematoria across the wider region. Your local funeral director arranges the cremation at the appropriate facility for your area; you'll know the date and time in advance.",
  crematoria: [
    {
      name: "Slough Crematorium",
      address: "Stoke Road, Slough SL2 5AX",
      note:
        "Slough Borough Council's crematorium, set in landscaped grounds north of the town."
    },
    {
      name: "Easthampstead Park Crematorium",
      address: "Off South Road, Wokingham RG40 3DW",
      note:
        "An alternative for the western Slough fringe."
    }
  ],
  ...
  registerOffice: {
    name: "Slough Register Office",
    address: "Town Hall, Bath Road, Slough SL1 3UQ",
    phone: "01753 875035",
    email: "registrars@slough.gov.uk",
    notes:
      "Deaths within Slough must be registered at the Slough Register Office. Appointment-only."
  },
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Wexham Street, SL2 4HL. Call ahead before visiting."
    }
  ],

  supportServices: [
    {
      name: "Thames Hospice — Bereavement Service",
      phone: "01753 848925",
      description: "Slough-area hospice offering bereavement counselling.",
      url: "https://www.thameshospice.org.uk"
    },
    {
      name: "Cruse Bereavement Support — Berkshire",
      phone: "0808 808 1677",
  ...
  faqs: [
    {
      question: "Which Slough crematorium will be used?",
      answer:
    ...
    {
      question: "How quickly can you collect from the local hospital in Slough?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Slough?",
      answer:
    ...
    {
      question: "Do you cover the wider Berkshire region?",
      answer:
        "Yes — we work with funeral directors and crematoria across Berkshire. The £1,499 price is the same wherever you are."
    },
    {
