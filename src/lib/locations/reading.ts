...
export const readingLocation: LocationData = {
  slug: "reading",
  city: "Reading",
  region: "Berkshire",
  country: "England",
  metaTitle: "Basic Cremation Reading | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Reading for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Berkshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Reading",
  lede:
  ...
  crematoria: [
    {
      name: "Reading Crematorium",
      address: "Henley Road, Caversham, Reading RG4 6LP",
      note:
  ...
  registerOffice: {
    name: "Reading Register Office",
    address: "Yeomanry House, 131 Castle Hill, Reading RG1 7TJ",
    phone: "0118 937 3535",
    email: "registrars@reading.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, London Road, RG1 5AN. Call ahead before visiting."
    },
    {
      name: "Wexham Park Hospital (Slough)",
      note: "Bereavement Services, Wexham Street, SL2 4HL."
    }
  ],

  supportServices: [
    {
      name: "Sue Ryder Duchess of Kent Hospice — Bereavement",
      phone: "0118 955 0750",
      description: "Reading-based hospice offering bereavement counselling.",
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Reading cremation?",
      answer:
    ...
    {
      question: "How quickly can you collect from the Royal Berkshire Hospital?",
      answer:
    ...
    {
      question: "Do you cover Wokingham, Newbury, Henley and the Thames Valley?",
      answer:
    ...
    {
      question: "Can ashes be scattered on the Thames or in the Chilterns?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Reading?",
      answer:
    ...
    {
      question: "Can the family pick the date of the cremation?",
      answer:
  ...
  cityImageAlt: "Reading — peaceful local scene"
};
