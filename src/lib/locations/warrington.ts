...
export const warringtonLocation: LocationData = {
  slug: "warrington",
  city: "Warrington",
  region: "Cheshire",
  country: "England",
  metaTitle: "Basic Cremation Warrington | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Warrington for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Cheshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Warrington",
  lede:
    "A simple, dignified cremation arranged across Warrington and Cheshire — handled by trusted local funeral directors and local crematoria, never centralised hundreds of miles away.",

  localIntro: [
    "If you've lost someone in Warrington or anywhere across Cheshire, we can help you arrange a basic cremation — also called a direct or unattended cremation. The whole process happens locally: an independent funeral director near you brings your loved one into care at their own funeral home, and the cremation takes place at one of the established Cheshire crematoria.",
    "Warrington is in Cheshire, between Manchester and Liverpool. Walton Lea Crematorium serves the borough.",
  ...
  crematoriaIntro:
    "We work with Walton Lea, Howe Bridge — alongside other crematoria across the wider region. Your local funeral director arranges the cremation at the appropriate facility for your area; you'll know the date and time in advance.",
  crematoria: [
    {
      name: "Walton Lea Crematorium",
      address: "Chester Road, Higher Walton, Warrington WA4 6TB",
      note:
        "Warrington Borough Council's crematorium, set in 33 acres of landscaped grounds south of the town."
    },
    {
      name: "Howe Bridge Crematorium",
      address: "Lovers Lane, Atherton, Manchester M46 0PZ",
      note:
        "Wigan Council crematorium also accessible for the eastern Warrington fringe."
    }
  ],
  ...
  registerOffice: {
    name: "Warrington Register Office",
    address: "Cheshire Lines Building, 1 Suez Street, Warrington WA1 2NJ",
    phone: "01925 442119",
    email: "registrars@warrington.gov.uk",
    notes:
      "Deaths within Warrington must be registered at the Cheshire Lines Building Register Office. Appointment-only."
  },
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Lovely Lane, WA5 1QG. Call ahead before visiting."
    }
  ],

  supportServices: [
    {
      name: "St Rocco's Hospice — Bereavement Service",
      phone: "01925 575780",
      description: "Warrington hospice offering bereavement counselling.",
      url: "https://www.stroccos.org.uk"
    },
    {
  ...
  faqs: [
    {
      question: "Which Warrington crematorium will be used?",
      answer:
    ...
    {
      question: "How quickly can you collect from the local hospital in Warrington?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Warrington?",
      answer:
