...
export const wolverhamptonLocation: LocationData = {
  slug: "wolverhampton",
  city: "Wolverhampton",
  region: "West Midlands",
  country: "England",
  metaTitle: "Basic Cremation Wolverhampton | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Wolverhampton for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and West Midlands crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Wolverhampton",
  lede:
  ...
  crematoria: [
    ...
    {
      name: "West Bromwich Crematorium",
      address: "Forge Lane, West Bromwich B71 3SX",
      note:
  ...
  registerOffice: {
    name: "Wolverhampton Register Office",
    address: "Civic Centre, St Peter's Square, Wolverhampton WV1 1RU",
    phone: "01902 551234",
    email: "registrars@wolverhampton.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Wolverhampton Road, Heath Town WV10 0QP. Call ahead before visiting."
    }
  ],

  supportServices: [
    {
      name: "Compton Care — Bereavement Service",
      phone: "0300 323 0250",
      description: "Wolverhampton-based hospice care charity offering bereavement counselling.",
      url: "https://www.comptoncare.org.uk"
    },
    {
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Wolverhampton cremation?",
      answer:
    ...
    {
      question: "How quickly can you collect from New Cross Hospital?",
      answer:
    ...
    {
      question: "Do you cover Walsall, Dudley, Sandwell and the wider Black Country?",
      answer:
    ...
    {
      question: "Can ashes be scattered at a meaningful Black Country site?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Wolverhampton?",
      answer:
  ...
  cityImageAlt: "Wolverhampton — peaceful local scene"
};
