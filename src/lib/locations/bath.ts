...
export const bathLocation: LocationData = {
  slug: "bath",
  city: "Bath",
  region: "Somerset",
  country: "England",
  metaTitle: "Basic Cremation Bath | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Bath for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Somerset crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Bath",
  lede:
  ...
  crematoria: [
    {
      name: "Haycombe Cemetery and Crematorium",
      address: "Whiteway Road, Bath BA2 2RQ",
      note:
  ...
  registerOffice: {
    name: "Bath Register Office",
    address: "33 Manvers Street, Bath BA1 1JW",
    phone: "01225 477234",
    email: "registers@bathnes.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      name: "Royal United Hospital Bath (RUH)",
      note: "Bereavement Office, Combe Park, BA1 3NG. Call ahead before visiting."
    }
  ],

  supportServices: [
    {
      name: "Dorothy House Hospice — Bereavement Service",
      phone: "01225 722988",
      description: "Bath-area hospice offering bereavement counselling.",
      url: "https://www.dorothyhouse-hospice.org.uk"
    },
    {
      name: "Cruse Bereavement Support — Somerset",
      phone: "0808 808 1677",
  ...
  faqs: [
    {
      question: "Which Bath crematorium will be used?",
      answer:
    ...
    {
      question: "How quickly can you collect from the local hospital in Bath?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Bath?",
      answer:
    ...
    {
      question: "Do you cover the wider Somerset region?",
      answer:
  ...
  cityImageAlt: "Bath — Georgian stone architecture"
};
