...
export const birminghamLocation: LocationData = {
  slug: "birmingham",
  city: "Birmingham",
  region: "West Midlands",
  country: "England",
  metaTitle: "Basic Cremation Birmingham | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Birmingham for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and West Midlands crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Birmingham",
  lede:
  ...
  crematoria: [
    {
      name: "Lodge Hill Crematorium",
      address: "Weoley Park Road, Selly Oak, Birmingham B29 5AA",
      note:
    ...
    {
      name: "Yardley Crematorium",
      address: "Yardley Cemetery, Robin Hood Lane, Hall Green, Birmingham B28 9HW",
      note:
    ...
    {
      name: "Sutton Coldfield Crematorium",
      address: "Tamworth Road, Sutton Coldfield B75 6LG",
      note:
        "Serves Sutton Coldfield and north Birmingham. Modern crematorium with extensive memorial gardens."
    },
    {
      name: "Robin Hood Cemetery and Crematorium",
      address: "Streetsbrook Road, Solihull B90 3NL",
      note:
        "Operated by Solihull Council, serving Solihull, Shirley, Hall Green and the southern Birmingham borders."
    },
    {
      name: "Woodlands Crematorium",
      address: "Woodlands Cemetery, Lichfield Road, Sutton Coldfield B74 2NA",
      note:
        "Privately operated crematorium in Sutton Coldfield — modern facilities and good road access from north Birmingham."
    },
    {
      name: "Streetly Crematorium",
      address: "Little Aston Road, Streetly, Sutton Coldfield B74 3AB",
      note:
  ...
  registerOffice: {
    ...
    address: "Holiday Wharf, 20 Holliday Street, Birmingham B1 1TJ",
    phone: "0121 675 1000",
  ...
  hospitalBereavement: [
    {
      name: "Queen Elizabeth Hospital Birmingham (QEHB)",
      note: "Bereavement Office, Mindelsohn Way, Edgbaston B15 2GW. Call ahead before visiting; the office liaises with the Medical Examiner."
    },
    {
      name: "Birmingham Heartlands Hospital",
      note: "Bereavement Services on the Bordesley Green East site, B9 5SS. Open weekdays."
    },
    {
      name: "Birmingham City Hospital",
      note: "Bereavement Office at the Dudley Road site, B18 7QH. Sandwell & West Birmingham NHS Trust."
    },
    {
      name: "Good Hope Hospital",
      note: "Sutton Coldfield, B75 7RR. Bereavement Office serves north Birmingham residents who died at Good Hope."
    }
  ],

  supportServices: [
    {
      name: "Cruse Bereavement Support — Birmingham",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Birmingham and the West Midlands. National helpline plus local volunteer-led services.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "Edward’s Trust",
      phone: "0121 454 1705",
      description: "Birmingham-based charity supporting bereaved children, young people and families across the West Midlands.",
      url: "https://www.edwardstrust.org.uk"
    },
    {
      name: "Acorns Children's Hospice — bereavement",
      phone: "0121 248 4850",
      description: "Bereavement support for families across the West Midlands following the death of a child.",
      url: "https://www.acorns.org.uk"
    },
    {
      name: "Birmingham St Mary's Hospice — Bereavement Service",
      phone: "0121 472 1191",
      description: "Bereavement counselling open to anyone in Birmingham, regardless of whether you used hospice services.",
      url: "https://www.birminghamhospice.org.uk"
    },
    {
  ...
  faqs: [
    {
      question: "Which Birmingham crematorium will be used?",
      answer:
    ...
    {
      question: "Do you cover Solihull, Sandwell, Walsall, Dudley and Wolverhampton?",
      answer:
    ...
    {
      question: "How quickly can you collect from a Birmingham hospital?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Birmingham?",
      answer:
    ...
    {
      question: "How long does the whole process usually take in Birmingham?",
      answer:
  ...
  cityImageAlt: "Birmingham — UK city skyline"
};
