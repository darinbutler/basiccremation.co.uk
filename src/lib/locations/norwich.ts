...
export const norwichLocation: LocationData = {
  slug: "norwich",
  city: "Norwich",
  region: "Norfolk",
  country: "England",
  metaTitle: "Basic Cremation Norwich | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Norwich for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Norfolk crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Norwich",
  lede:
  ...
  crematoria: [
    {
      name: "Earlham Cemetery and Crematorium",
      address: "Earlham Road, Norwich NR4 7HH",
      note:
        "Norwich City Council’s principal crematorium, opened in 1929. One of the oldest in East Anglia."
    },
    {
      name: "St Faith's Crematorium",
      address: "Manor Road, Horsham St Faith, Norwich NR10 3LF",
      note:
        "Privately operated crematorium serving the wider Norfolk countryside."
    },
    {
      name: "Mintlyn Crematorium",
      address: "Lynn Road, Bawsey, King's Lynn PE32 1HB",
      note:
  ...
  registerOffice: {
    name: "Norwich Register Office",
    address: "27 Castle Meadow, Norwich NR1 3DP",
    phone: "0344 800 8020",
    email: "ceremonies@norfolk.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Colney Lane, NR4 7UY. Call ahead before visiting."
    }
  ],

  supportServices: [
    {
      name: "Priscilla Bacon Hospice — Bereavement Service",
      phone: "01603 273 100",
      description: "Norwich-based hospice offering bereavement counselling.",
      url: "https://www.priscillabaconhospice.org.uk"
    },
    {
      name: "Cruse Bereavement Support — Norfolk",
      phone: "0808 808 1677",
  ...
  cityImage:
    "/images/cities/norwich.jpg",
  cityImageAlt: "Norwich — East Anglia atmosphere"
};
