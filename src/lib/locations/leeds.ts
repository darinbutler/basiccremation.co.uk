...
export const leedsLocation: LocationData = {
  slug: "leeds",
  city: "Leeds",
  region: "West Yorkshire",
  country: "England",
  metaTitle: "Basic Cremation Leeds | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Leeds for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and West Yorkshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Leeds",
  lede:
  ...
  crematoria: [
    {
      name: "Lawnswood Cemetery and Crematorium",
      address: "Otley Road, Lawnswood, Leeds LS16 6AH",
      note:
    ...
    {
      name: "Cottingley Hall Crematorium",
      address: "Cottingley Drive, Leeds LS11 0LF",
      note:
    ...
    {
      name: "Rawdon Crematorium",
      address: "Leeds Road, Rawdon, Leeds LS19 6JP",
      note:
  ...
  registerOffice: {
    name: "Leeds Register Office",
    address: "Belgrave House, 1 Belgrave Street, Leeds LS2 8DQ",
    phone: "0113 222 4408",
  ...
  hospitalBereavement: [
    {
      name: "Leeds General Infirmary (LGI)",
      note: "Bereavement Office, Great George Street, LS1 3EX. Call ahead before visiting."
    },
    {
      name: "St James's University Hospital (Jimmy's)",
      note: "Bereavement Office at the Beckett Street site, LS9 7TF. Open weekdays."
    },
    {
      name: "Seacroft Hospital and Wharfedale Hospital",
      note: "Smaller hospital sites in the Leeds Trust — bereavement coordinated through the central Leeds Teaching Hospitals bereavement office."
    }
  ],

  supportServices: [
    {
      name: "Cruse Bereavement Support — Leeds",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Leeds and West Yorkshire.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "Leeds Bereavement Forum",
      phone: "0113 225 3818",
      description: "Leeds-based network of bereavement charities and counsellors. Useful starting point if you’re not sure what kind of help you need.",
      url: "https://lbforum.org.uk"
    },
    {
      name: "Martin House Children's Hospice — bereavement",
      phone: "01937 845045",
      description: "Bereavement support for families across Yorkshire following the death of a child.",
      url: "https://www.martinhouse.org.uk"
    },
    {
      name: "St Gemma's Hospice — Bereavement Service",
      phone: "0113 218 5500",
      description: "Bereavement counselling open to anyone in Leeds, regardless of whether hospice services were used.",
      url: "https://www.st-gemma.co.uk"
    }
  ],
  ...
  faqs: [
    {
      question: "Which Leeds crematorium will be used?",
      answer:
    ...
    {
      question: "Do you cover Wakefield, Bradford and Huddersfield from a Leeds base?",
      answer:
    ...
    {
      question: "How quickly can you collect from a Leeds hospital?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Leeds?",
      answer:
    ...
    {
      question: "Can the ashes be scattered in the Yorkshire Dales or on the moors?",
      answer:
  ...
  cityImage:
    "https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=1800&q=75",
  cityImageAlt: "Leeds city skyline"
};
