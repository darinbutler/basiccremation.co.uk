...
export const bournemouthLocation: LocationData = {
  slug: "bournemouth",
  city: "Bournemouth",
  region: "Dorset",
  country: "England",
  metaTitle: "Basic Cremation Bournemouth | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Bournemouth for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Dorset crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Bournemouth",
  lede:
  ...
  crematoria: [
    {
      name: "Bournemouth North Cemetery and Crematorium",
      address: "Strouden Avenue, Bournemouth BH8 9HX",
      note:
        "BCP Council’s principal Bournemouth crematorium, opened in 1936."
    },
    {
      name: "Poole Crematorium",
      address: "Gravel Hill, Poole BH17 9BQ",
      note:
  ...
  registerOffice: {
    name: "Bournemouth Register Office",
    address: "Town Hall, Bourne Avenue, Bournemouth BH2 6DY",
    phone: "01202 451603",
    email: "register.office@bcpcouncil.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      ...
      note: "Bereavement Office, Castle Lane East, BH7 7DW. Call ahead before visiting."
    },
    {
      name: "Poole Hospital",
      note: "Bereavement Services, Longfleet Road, BH15 2JB."
    }
  ],

  supportServices: [
    {
      name: "Macmillan Caring Locally — Bereavement",
      phone: "01202 700 305",
      description: "Christchurch-based palliative care charity offering bereavement support.",
      url: "https://www.macmillanlocal.org"
    },
    {
      name: "Cruse Bereavement Support — Dorset",
      phone: "0808 808 1677",
  ...
  faqs: [
    {
      question: "Which crematorium will be used for a Bournemouth cremation?",
      answer:
    ...
    {
      question: "How quickly can you collect from the Royal Bournemouth or Poole Hospital?",
      answer:
    ...
    {
      question: "Do you cover Christchurch, Poole, New Milton and the Dorset coast?",
      answer:
    ...
    {
      question: "Can ashes be scattered on Bournemouth beach, the Purbecks or at sea?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Bournemouth?",
      answer:
    ...
    {
      question: "Will my loved one be looked after locally in BCP?",
      answer:
  ...
  cityImage:
    "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1800&q=75",
  cityImageAlt: "Bournemouth — South Coast beach"
};
