...
export const nottinghamLocation: LocationData = {
  slug: "nottingham",
  city: "Nottingham",
  region: "Nottinghamshire",
  country: "England",
  metaTitle: "Basic Cremation Nottingham | £1,499 Direct Cremation | 24/7",
  metaDescription:
    "Arrange a basic cremation in Nottingham for £1,499 — single all-inclusive price, no hidden fees. Trusted local funeral directors and Nottinghamshire crematoria. 24/7 phone support.",
  h1: "Basic Cremation in Nottingham",
  lede:
  ...
  crematoria: [
    {
      name: "Wilford Hill Crematorium",
      address: "Wilford Hill, West Bridgford, Nottingham NG2 7FE",
      note:
    ...
    {
      name: "Bramcote Crematorium",
      address: "Coventry Lane, Bramcote, Nottingham NG9 3GJ",
      note:
    ...
    {
      name: "Mansfield Crematorium",
      address: "Derby Road, Mansfield NG18 4AF",
      note:
    ...
    },
    {
      ...
      address: "Catfoot Lane, Lambley NG4 4QH",
      note:
  ...
  registerOffice: {
    name: "Nottingham Register Office",
    address: "The Council House, Old Market Square, Nottingham NG1 2DT",
    phone: "0115 841 5554",
    email: "registration@nottinghamcity.gov.uk",
    notes:
  ...
  hospitalBereavement: [
    {
      name: "Queen's Medical Centre (QMC)",
      note: "Bereavement Office, Derby Road, NG7 2UH. Call ahead before visiting."
    },
    {
      name: "Nottingham City Hospital",
      note: "Bereavement Services, Hucknall Road, NG5 1PB. Open weekdays."
    },
    {
      name: "Nottingham Children's Hospital",
      note: "Specialist child bereavement support. Located within the QMC site."
    }
  ],

  supportServices: [
    {
      name: "Cruse Bereavement Support — Nottinghamshire",
      phone: "0808 808 1677",
      description: "Free, confidential bereavement support across Nottinghamshire.",
      url: "https://www.cruse.org.uk"
    },
    {
      name: "Hayward House — Bereavement Service",
      phone: "0115 962 7619",
      description: "Specialist palliative care unit at Nottingham City Hospital, offering bereavement support to anyone in Nottinghamshire.",
  ...
  faqs: [
    {
      question: "Which Nottingham crematorium will be used?",
      answer:
    ...
    {
      question: "Do you cover Mansfield, Newark, Worksop and the rest of Nottinghamshire?",
      answer:
    ...
    {
      question: "How quickly can you collect from QMC or City Hospital?",
      answer:
    ...
    {
      question: "What if my loved one died at home in Nottingham?",
      answer:
    ...
    {
      question: "Can ashes be scattered in Sherwood Forest or on the Trent?",
      answer:
